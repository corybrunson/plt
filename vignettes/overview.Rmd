...
As we can see, clustering of samples from the same sample did occur. We observe that the between-group variance is mainly contained in the first principal component. And the within-group variance of $P_1$ is smaller than the within-group variance of $P_2$. 
