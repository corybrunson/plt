...
In this vignette, we will show how {plt} supports the computation of persistence landscapes[^1], and both exploratory and predictive analysis. The construction of persistence landscapes has useful properties for machine learning and hypothesis testing. This vignette is based on Bubenik's TDA labs[^2].

# Basic use of TDA in Statistics and Machine Learning

**Topological data analysis** (TDA) involves the use of algebraic topology to analyze data. The goal is to measure global topological features. A typical procedure is to: 
