...
Below we sample $60$ points from a toy point cloud sampler for a figure eight (lemniscate) in $\mathbb{R}^2$ with noise. Observe that the dominant features of the figure eight, the $1$-dimensional holes, are visible when we plot the points. 
...
$$
where $n \in \mathbb{N}$ is the number of simplicial complexes in the filtration. Note that for any pair of adjacent terms (simplicial complexes) in the filtration, the preceding term is a **subcomplex** of the succeeding term. In the below section, we visualize the alpha complex filtration built upon the point cloud. 
