...
The plots below show the alpha complex at six different levels of the filtration parameter, specifically for $\alpha = (0,0.05,0.1,0.175,0.35,0.4)$, which controls the radius of the balls.

```{r,echo = FALSE,fig.align = 'center'}
par(mfrow = c(2, 3), mar = c(0,2,0,0.5))
