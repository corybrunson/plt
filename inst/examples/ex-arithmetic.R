...
pl <- landscape(pd, degree = 1, exact = FALSE, xmax = 2.5, by=0.1)
...
x_pl <- landscape(x_pd, degree = 1, exact = FALSE, xmax = 2.5, by = 0.1)
y_pl <- landscape(y_pd, degree = 1, exact = FALSE, xmax = 2.5, by = 0.1)
