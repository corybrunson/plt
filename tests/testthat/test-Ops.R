...
test_that("Addition expands domain as needed.", {
  ...
  pl2 <- landscape(matrix(c(2, 4), ncol = 2L), exact = TRUE, xby = 0.2)
  pl12 <- pl1 + pl2
  ...
  pl1 <- landscape(matrix(c(1, 3), ncol = 2L), exact = FALSE, xby = .2)
  pl2 <- landscape(matrix(c(2, 4), ncol = 2L), exact = FALSE, xby = .2)
  pl12 <- pl1 + pl2
  expect_equal(pl12$xMin(), min(pl1$xMin(), pl2$xMin()))
  expect_equal(pl12$xMax(), max(pl1$xMax(), pl2$xMax()))
  expect_equal(pl12$xBy(), pl1$xBy())
  ...
  pl1 <- landscape(matrix(c(1, 3), ncol = 2L), exact = TRUE, xby = .1)
  pl2 <- landscape(matrix(c(2, 4), ncol = 2L), exact = FALSE, xby = .2)
  pl12 <- pl1 + pl2
  expect_equal(pl12$xMin(), min(pl1$xMin(), pl2$xMin()))
  expect_equal(pl12$xMax(), max(pl1$xMax(), pl2$xMax()))
